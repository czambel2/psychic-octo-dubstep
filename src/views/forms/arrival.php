<div class="row">
	...
	<div class="nine columns">
		<input data-race-number="<?= $this->getMiscData('raceNumber') ?>" name="data[cyclistName]" class="autocomplete-cyclists-filter arrival" required="required" id="data_cyclistName" placeholder="Rechercher un cycliste" type="text" <?= $this->errorClass('cyclistName') ?> />
